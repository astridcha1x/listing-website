...
INSERT INTO users (name, email, phone, password, address) VALUES ('Nick Azurin', 'example2@lhl.com', '6041111112', 'password', '112 1st avenue W, Vancouver, BC V5Z 0B9');
...
INSERT INTO users (name, email, phone, password, address) VALUES ('Bradley Fung', 'example4@lhl.com', '6041111114', 'password', '114 1st avenue W, Vancouver, BC V5Z 0B9');
...
INSERT INTO products (name, image, type, description, quantity, price, user_id) VALUES ('Selma Cactus', 'https://images.unsplash.com/photo-1508022057371-4f937727f440?ixid=MnwxMjA3fDB8MHxwcm9maWxlLXBhZ2V8NTR8fHxlbnwwfHx8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60', 'indoor', 'description here', 4, 4000, 5);
INSERT INTO products (name, image, type, description, quantity, price, user_id) VALUES ('Kaya Cactus', 'https://images.unsplash.com/photo-1509587584298-0f3b3a3a1797?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwcm9maWxlLXBhZ2V8MzN8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60', 'outdoor', 'description here', 3, 2000, 5);
INSERT INTO products (name, image, type, description, quantity, price, user_id) VALUES ('Kaya Cactus', 'https://images.unsplash.com/photo-1509221977468-59ebf138e25e?ixid=MnwxMjA3fDB8MHxwcm9maWxlLXBhZ2V8NDR8fHxlbnwwfHx8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60', 'outdoor', 'description here', 5, 2500, 5);
INSERT INTO products (name, image, type, description, quantity, price, user_id) VALUES ('Leighton Cactus', 'https://images.unsplash.com/photo-1509221047594-b87944387edf?ixid=MnwxMjA3fDB8MHxwcm9maWxlLXBhZ2V8NDZ8fHxlbnwwfHx8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60', 'outdoor', 'description here', 7, 3000, 5);
...
-- message_details
INSERT INTO message_details (sender_id, date_time, message_text, message_master_id) VALUES (1, '2021-05-27', 'Hello I''m interested in your Mini Cactus! Do you do meet ups by chance?', 1);
INSERT INTO message_details (sender_id, date_time, message_text, message_master_id) VALUES (2, '2021-05-27', 'Sure! Do you want to meet up at Waterfront station at 2pm tomorrow?', 1);
